...
| --- | --- | ---: | ---: | ---: | --- |
| symbol_discovery_callTool | pass | 6084 | 50 | 99.2 | Find the callTool symbol with broad text search versus compact MCP symbol search. |
...
| performance_scale_10k_symbols | pass | - | - | - | Cold index: 7490ms for 1000 files/10001 symbols; search: 7.5ms; caller: 2.2ms; incremental: 207.9ms for 1 changed file; risk: 280.3ms for 26 changed files; db: 8.3MB. |
| performance_monorepo_workspace | pass | - | - | - | Cold index: 5049ms for 20 packages/800 files/4801 symbols; search: 3.1ms; caller: 1.7ms; incremental: 253.8ms for 1 changed file; risk: 168.2ms for 6 changed files; db: 12.5MB. |
