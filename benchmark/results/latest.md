...
| --- | --- | ---: | ---: | ---: | --- |
| symbol_discovery_callTool | pass | 6452 | 50 | 99.2 | Find the callTool symbol with broad text search versus compact MCP symbol search. |
...
| performance_scale_10k_symbols | pass | - | - | - | Cold index: 5588ms for 1000 files/10001 symbols; search: 4.1ms; caller: 2.2ms; incremental: 125.7ms for 1 changed file; risk: 179.5ms for 26 changed files; db: 8.3MB. |
| performance_monorepo_workspace | pass | - | - | - | Cold index: 4111ms for 20 packages/800 files/4801 symbols; search: 1.9ms; caller: 1ms; incremental: 166.8ms for 1 changed file; risk: 114.7ms for 6 changed files; db: 12.6MB. |
