...
| `language_depth_js_python_callers` | JavaScript symbol extraction plus Python same-file, async, from-import, re-export, module-import, inheritance, `super()`, instance-method caller extraction, and first-layer Go caller extraction. |
...
- First-layer Go checks for function/type/method indexing, same-package calls, module import calls, and receiver method calls.
