...
| --- | --- | ---: | ---: | ---: | --- |
| symbol_discovery_callTool | pass | 6639 | 50 | 99.2 | Find the callTool symbol with broad text search versus compact MCP symbol search. |
...
| performance_scale_10k_symbols | pass | - | - | - | Cold index: 5809ms for 1000 files/10001 symbols; search: 4.4ms; caller: 2.2ms; incremental: 146.5ms for 1 changed file; risk: 216.7ms for 26 changed files; db: 8.3MB. |
| performance_monorepo_workspace | pass | - | - | - | Cold index: 3895ms for 20 packages/800 files/4801 symbols; search: 2ms; caller: 1ms; incremental: 173.8ms for 1 changed file; risk: 110.9ms for 6 changed files; db: 12.6MB. |
