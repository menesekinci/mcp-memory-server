...
| --- | --- | ---: | ---: | ---: | --- |
| symbol_discovery_callTool | pass | 5810 | 50 | 99.1 | Find the callTool symbol with broad text search versus compact MCP symbol search. |
...
| performance_scale_10k_symbols | pass | - | - | - | Cold index: 7282ms for 1000 files/10001 symbols; search: 5.2ms; caller: 2.6ms; incremental: 178.3ms for 1 changed file; risk: 237.8ms for 26 changed files; db: 8.3MB. |
| performance_monorepo_workspace | pass | - | - | - | Cold index: 5285ms for 20 packages/800 files/4801 symbols; search: 2.5ms; caller: 1.4ms; incremental: 254.2ms for 1 changed file; risk: 165.6ms for 6 changed files; db: 12.5MB. |
