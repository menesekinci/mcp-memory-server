...
| --- | --- | ---: | ---: | ---: | --- |
| symbol_discovery_callTool | pass | 5625 | 50 | 99.1 | Find the callTool symbol with broad text search versus compact MCP symbol search. |
...
| performance_scale_10k_symbols | pass | - | - | - | Cold index: 5436ms for 1000 files/10001 symbols; search: 4.1ms; caller: 2.1ms; incremental: 130.2ms for 1 changed file; risk: 178.2ms for 26 changed files; db: 8.2MB. |
| performance_monorepo_workspace | pass | - | - | - | Cold index: 3720ms for 20 packages/800 files/4801 symbols; search: 2ms; caller: 1ms; incremental: 167.5ms for 1 changed file; risk: 118.4ms for 6 changed files; db: 12.6MB. |
