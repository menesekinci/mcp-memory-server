...
| --- | --- | ---: | ---: | ---: | --- |
| symbol_discovery_callTool | pass | 6357 | 50 | 99.2 | Find the callTool symbol with broad text search versus compact MCP symbol search. |
...
| performance_scale_10k_symbols | pass | - | - | - | Cold index: 5647ms for 1000 files/10001 symbols; search: 4.2ms; caller: 2.2ms; incremental: 152.9ms for 1 changed file; risk: 199.6ms for 26 changed files; db: 8.3MB. |
| performance_monorepo_workspace | pass | - | - | - | Cold index: 4301ms for 20 packages/800 files/4801 symbols; search: 2.8ms; caller: 1.3ms; incremental: 177.5ms for 1 changed file; risk: 108.6ms for 6 changed files; db: 12.5MB. |
