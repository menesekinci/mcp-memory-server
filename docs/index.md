...
Codex MCP Memory Server is a symbol-aware MCP server for coding agents. It indexes project symbols, stores memory in SQLite, and returns compact discovery results before an agent reads full source.
