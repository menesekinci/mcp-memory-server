...
| performance_scale_10k_symbols | pass | - | - | - | Cold index: 5364ms for 1000 files/10001 symbols; search: 3.8ms; caller: 1.9ms; incremental: 121.5ms for 1 changed file; risk: 175.7ms for 26 changed files; db: 8.3MB. |
| performance_monorepo_workspace | pass | - | - | - | Cold index: 4206ms for 20 packages/800 files/4801 symbols; search: 1.9ms; caller: 0.9ms; incremental: 161.9ms for 1 changed file; risk: 103.1ms for 6 changed files; db: 12.6MB. |
