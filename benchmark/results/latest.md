...
| --- | --- | ---: | ---: | ---: | --- |
| symbol_discovery_callTool | pass | 4593 | 45 | 99 | Find the callTool symbol with broad text search versus compact MCP symbol search. |
...
| performance_scale_10k_symbols | pass | - | - | - | Cold index: 5432ms for 1000 files/10001 symbols; search: 4.7ms; caller: 2.4ms; incremental: 163.9ms for 1 changed file; risk: 136.4ms for 26 changed files; db: 8.1MB. |
| performance_monorepo_workspace | pass | - | - | - | Cold index: 3569ms for 20 packages/800 files/4801 symbols; search: 2ms; caller: 1ms; incremental: 198.1ms for 1 changed file; risk: 124.9ms for 6 changed files; db: 12.4MB. |
