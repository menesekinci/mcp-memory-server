...
- Early Go checks for function/type/method indexing, same-package calls, module import calls, local `replace` imports, vendor imports, `go.work` workspace imports, local constructor-assigned instance method calls, receiver method calls, embedded struct promoted method calls, simple interface parameter dispatch, generated Go file exclusion, and explicit `ignore` build-constraint exclusion.
