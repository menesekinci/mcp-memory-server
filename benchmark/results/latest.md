...
| --- | --- | ---: | ---: | ---: | --- |
| symbol_discovery_callTool | pass | 6731 | 50 | 99.3 | Find the callTool symbol with broad text search versus compact MCP symbol search. |
...
| performance_scale_10k_symbols | pass | - | - | - | Cold index: 5663ms for 1000 files/10001 symbols; search: 3.9ms; caller: 1.9ms; incremental: 125.1ms for 1 changed file; risk: 178ms for 26 changed files; db: 8.3MB. |
| performance_monorepo_workspace | pass | - | - | - | Cold index: 4216ms for 20 packages/800 files/4801 symbols; search: 1.9ms; caller: 1ms; incremental: 171.9ms for 1 changed file; risk: 107.4ms for 6 changed files; db: 12.6MB. |
