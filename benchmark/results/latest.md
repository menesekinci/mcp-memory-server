...
| --- | --- | ---: | ---: | ---: | --- |
| symbol_discovery_callTool | pass | 3957 | 45 | 98.9 | Find the callTool symbol with broad text search versus compact MCP symbol search. |
...
| performance_scale_10k_symbols | pass | - | - | - | Cold index: 4315ms for 1000 files/10001 symbols; search: 4ms; caller: 2.4ms; incremental: 154.5ms for 1 changed file; risk: 1191ms for 26 changed files; db: 7.3MB. |
