...
| --- | --- | ---: | ---: | ---: | --- |
| symbol_discovery_callTool | pass | 4698 | 50 | 98.9 | Find the callTool symbol with broad text search versus compact MCP symbol search. |
...
| bugfix_investigation_narrowing | pass | 1573 | 352 | 77.6 | Narrow a noisy discount regression from broad text matches to compact symbol, history, and decision context. |
...
| performance_scale_10k_symbols | pass | - | - | - | Cold index: 5406ms for 1000 files/10001 symbols; search: 3.9ms; caller: 2ms; incremental: 157.1ms for 1 changed file; risk: 217.5ms for 26 changed files; db: 8.1MB. |
| performance_monorepo_workspace | pass | - | - | - | Cold index: 3553ms for 20 packages/800 files/4801 symbols; search: 2.2ms; caller: 1.1ms; incremental: 214.5ms for 1 changed file; risk: 138ms for 6 changed files; db: 12.4MB. |
