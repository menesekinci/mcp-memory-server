...
| --- | --- | ---: | ---: | ---: | --- |
| symbol_discovery_callTool | pass | 4236 | 45 | 98.9 | Find the callTool symbol with broad text search versus compact MCP symbol search. |
...
| performance_scale_10k_symbols | pass | - | - | - | Cold index: 4821ms for 1000 files/10001 symbols; search: 3.6ms; caller: 2.3ms; incremental: 125.4ms for 1 changed file; risk: 1187.5ms for 26 changed files; db: 7.3MB. |
| performance_monorepo_workspace | pass | - | - | - | Cold index: 3170ms for 20 packages/800 files/4801 symbols; search: 1.9ms; caller: 1ms; incremental: 165.8ms for 1 changed file; risk: 254.9ms for 6 changed files; db: 11.1MB. |
