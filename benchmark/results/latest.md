...
| performance_scale_10k_symbols | pass | - | - | - | Cold index: 5562ms for 1000 files/10001 symbols; search: 4.1ms; caller: 2.2ms; incremental: 130.3ms for 1 changed file; risk: 180.9ms for 26 changed files; db: 8.3MB. |
| performance_monorepo_workspace | pass | - | - | - | Cold index: 3732ms for 20 packages/800 files/4801 symbols; search: 2ms; caller: 1ms; incremental: 165.5ms for 1 changed file; risk: 106.7ms for 6 changed files; db: 12.6MB. |
