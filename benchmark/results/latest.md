...
| --- | --- | ---: | ---: | ---: | --- |
| symbol_discovery_callTool | pass | 5194 | 50 | 99 | Find the callTool symbol with broad text search versus compact MCP symbol search. |
...
| performance_scale_10k_symbols | pass | - | - | - | Cold index: 5361ms for 1000 files/10001 symbols; search: 4.8ms; caller: 2.5ms; incremental: 124.8ms for 1 changed file; risk: 184.2ms for 26 changed files; db: 8.2MB. |
| performance_monorepo_workspace | pass | - | - | - | Cold index: 3716ms for 20 packages/800 files/4801 symbols; search: 2ms; caller: 1ms; incremental: 171.2ms for 1 changed file; risk: 109.9ms for 6 changed files; db: 12.5MB. |
