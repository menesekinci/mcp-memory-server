...
| --- | --- | ---: | ---: | ---: | --- |
| symbol_discovery_callTool | pass | 3864 | 45 | 98.8 | Find the callTool symbol with broad text search versus compact MCP symbol search. |
...
| language_depth_js_python_callers | pass | - | - | - | JavaScript callers: checkout; Python same-file: checkout_py; Python from-import: checkout_external_py; Python module-import: checkout_module_py. |
...
| performance_scale_10k_symbols | pass | - | - | - | Cold index: 4777ms for 1000 files/10001 symbols; search: 3.6ms; caller: 2ms; incremental: 118.3ms for 1 changed file; risk: 1107ms for 26 changed files; db: 7.3MB. |
