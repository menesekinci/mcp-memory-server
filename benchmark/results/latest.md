...
| --- | --- | ---: | ---: | ---: | --- |
| symbol_discovery_callTool | pass | 5325 | 50 | 99.1 | Find the callTool symbol with broad text search versus compact MCP symbol search. |
...
| performance_scale_10k_symbols | pass | - | - | - | Cold index: 5789ms for 1000 files/10001 symbols; search: 4ms; caller: 2ms; incremental: 138.3ms for 1 changed file; risk: 186.8ms for 26 changed files; db: 8.2MB. |
| performance_monorepo_workspace | pass | - | - | - | Cold index: 3399ms for 20 packages/800 files/4801 symbols; search: 2.5ms; caller: 1.3ms; incremental: 169.1ms for 1 changed file; risk: 108.7ms for 6 changed files; db: 12.5MB. |
